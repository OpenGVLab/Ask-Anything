...
model = dict(
    ...
    vit_blip_model_path="/mnt/petrelfs/yanziang/Ask-Anything/video_chat2/ckpts/umt_l16_qformer.pth",
    llama_model_path="/mnt/petrelfs/yanziang/Ask-Anything/video_chat2/ckpts/vicuna-7b-v0",
    freeze_vit=False,
